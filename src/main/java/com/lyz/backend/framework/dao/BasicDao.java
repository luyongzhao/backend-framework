package com.lyz.backend.framework.dao;


import com.lyz.backend.framework.controller.bean.PageLimit;
import com.lyz.backend.framework.dao.dto.DtoIdxSupport;
...
public interface BasicDao {
    ...
    public abstract <T> T executeQuery(HibernateCallback<T> callback);

    public abstract <T> T executeUpdate(HibernateCallback<T> callback);
    ...
    public abstract SessionFactory getSessionFacotry();

    public abstract void setSessionFacotry(SessionFactory sessionFacotry);
