...
{
	private static org.apache.commons.logging.Log log = LogFactory.getLog(XmlResponseHandler.class);
			...
			ResponseHandler<T> responseHandler = new ResponseHandler<T>()
			{
				...
				public T handleResponse(HttpResponse response) throws ClientProtocolException, IOException
				{
					...
					if (status >= 200 && status < 300)
					{
						...
						{
							return XMLConverUtil
									.convertToObject(clazz, new String(str.getBytes("iso-8859-1"), "utf-8"));
						}
					} else
					{
